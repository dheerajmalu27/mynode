...
const create = async function(req, res){
    ...
    [err, feespaidbystudentObj] = await to(FeesPaidByStudent.create(feespaidbystudentInfo));
...
const update = async function(req, res){
    ...
    return ReS(res, {message :'Updated FeesPaidByStudent: '+feespaidbystudentObj.feeId});
}

...
router.get('/attendancedatewisereport', passport.authenticate('jwt', {session:false}), AttendanceController.getByRecordWithDateRange);     // R

router.get('/getBbyrecordwithdaterange', passport.authenticate('jwt', {session:false}),  AttendanceController.getByRecordWithDateRange);     // R
...
router.get('/subjectlist', passport.authenticate('jwt', {session:false}), SubjectController.getAllList);                  // R
router.get('/getsubjecttestlist', passport.authenticate('jwt', {session:false}), SubjectController.getSubjectTestList);                  // R
router.get('/subject/:subjectId', passport.authenticate('jwt', {session:false}),  custom.subject, SubjectController.get);     // R
...
router.post('/bulktimetable', passport.authenticate('jwt', {session:false}), TimetableController.bulkCreate); 
router.delete('/timetable/:timetableId', passport.authenticate('jwt', {session:false}), custom.timetable, TimetableController.remove);  // D
